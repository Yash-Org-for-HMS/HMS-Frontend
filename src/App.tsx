...
const OtCaseBilling = lazy(() => import("@/features/ipd/OtCaseBilling"));
      ...
      <Routes>
        ...
        <Route element={<HospitalProtectedRoute panel="hospital" />}>
          <Route element={el(HospitalLayout)}>
            ...
            <Route path="/hospital/ipd/ot-schedule" element={elGated(OtSchedule, "IPD", "Operating List", { readOnly: true })} />
            <Route path="/hospital/ipd/ot-cases/:id" element={elGated(OtCaseRecord, "IPD", "Operative Record")} />
            <Route path="/hospital/ipd/ot-reports" element={elGated(OtReports, "IPD", "Theatre Reports")} />
        ...
        <Route element={<HospitalProtectedRoute panel="reception" />}>
          <Route element={el(ReceptionLayout)}>
            ...
            {/* Reception bills a case; the clinical record and the theatre
                reports are not front-desk work (the server refuses them too). */}
            <Route path="/reception/ipd/ot-cases/:id" element={elGated(OtCaseBilling, "IPD", "Operating List")} />
