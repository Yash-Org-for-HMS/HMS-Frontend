...
export default function HospitalLayout() {
  ...
  const menuItems = [
    ...
    { text: "Insurance Reports", icon: <AssessmentRounded />, path: "/hospital/claims/reports", adminOnly: true, section: "Overview" },
    { text: "Nursing Reports", icon: <AssessmentRounded />, path: "/hospital/nurse-reports", adminOnly: true, section: "Overview" },
    ...
    { text: "Theatre Reports", icon: <EventNoteRounded />, path: "/hospital/ipd/ot-reports", adminOnly: true, module: "IPD", section: "Operations" },
